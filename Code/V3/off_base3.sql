...
CREATE TABLE `stored_product` (
  `stored_bar_code` bigint NOT NULL,
  PRIMARY KEY (`stored_bar_code`),
  KEY `fk_stored_bar_code` (`stored_bar_code`), 
  CONSTRAINT `fk_stored_bar_code` FOREIGN KEY (`stored_bar_code`) REFERENCES `product` (`bar_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
